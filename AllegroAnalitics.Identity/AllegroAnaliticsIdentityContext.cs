...
namespace AllegroAnalitics.Data.Identity
{
    public class AllegroAnaliticsIdentityContext : IdentityDbContext
    {
        public AllegroAnaliticsIdentityContext(DbContextOptions<AllegroAnaliticsIdentityContext> options) : base(options) { }
